...
In this case, however, we want to leverage [Hero animations](https://flutter.dev/docs/cookbook/navigation/hero-animations) to create a page transition, while retaining full control of the animation easing curve and timing. We also want our `FloatingActionButton` to morph into the new page instead of the page just popping up on screen.
